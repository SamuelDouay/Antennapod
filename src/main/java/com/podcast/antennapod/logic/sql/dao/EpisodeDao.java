package com.podcast.antennapod.logic.sql.dao;

import com.podcast.antennapod.item.EpisodeItem;
import com.podcast.antennapod.logic.sql.setting.Connect;
    ...
    public List<EpisodeItem> getTop8InQueue() {
        ...
        try (PreparedStatement stmt = Connect.getInstance().getConnection().prepareStatement(sql);
            ...
            while (resultSet.next()) {
                ...
                String img_url = resultSet.getString("image_url");
                res.add(new EpisodeItem(img_url, false, title, null, date, null, false));
            }
